                  ...
                  <Link key={index} to={getActionRoute(action.title)}>
                    <Card className="glass border-white/20 bg-transparent glow-hover cursor-pointer h-full">
                      <CardContent className="p-4">
                        <div
                          className={`w-12 h-12 rounded-xl bg-gradient-to-r ${action.gradient} flex items-center justify-center mb-3 glow-effect`}
                        >
                          {action.icon}
                        </div>
            ...
            <Card className="glass border-white/20 bg-transparent">
              ...
              <CardContent className="space-y-4">
                {recentActivity.map((activity, index) => (
                  <div
                    key={index}
                    className="flex items-start space-x-3 p-3 glass rounded-lg border border-white/5"
                  >
                    <div
