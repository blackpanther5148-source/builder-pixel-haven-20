...
export default function Portfolio() {
  ...
  const projectCategories = [
    { id: "all", name: "All Projects", count: 12, icon: <Briefcase className="w-4 h-4" /> },
    { id: "web", name: "Web Development", count: 6, icon: <Globe className="w-4 h-4" /> },
    { id: "mobile", name: "Mobile Apps", count: 3, icon: <Smartphone className="w-4 h-4" /> },
    { id: "ui", name: "UI/UX Design", count: 2, icon: <Palette className="w-4 h-4" /> },
    { id: "backend", name: "Backend", count: 1, icon: <Database className="w-4 h-4" /> }
  ];
  ...
  const projects = [
    ...
    },
    {
      ...
      description: "iOS and Android app for fitness tracking and health monitoring",
      category: "mobile",
      image: "/placeholder.svg",
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      <div className="relative z-10 container mx-auto px-4 py-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
          ...
          <Card className="glass border-white/20 bg-transparent">
            <CardContent className="p-4 text-center">
              <div className="text-2xl font-bold gradient-text">{stats.totalLikes}</div>
              <div className="text-gray-400 text-sm">Total Likes</div>
            </CardContent>
          </Card>
          <Card className="glass border-white/20 bg-transparent">
            <CardContent className="p-4 text-center">
              <div className="text-2xl font-bold gradient-text">{stats.featuredProjects}</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredProjects.map((project) => (
            <Card key={project.id} className="glass border-white/20 bg-transparent glow-hover group">
              <div className="relative overflow-hidden rounded-t-lg">
                ...
                <div className="absolute bottom-4 right-4 opacity-0 group-hover:opacity-100 transition-opacity">
                  <div className="flex space-x-2">
                    {project.liveUrl && (
                      <Button size="sm" className="glass border-white/20 text-white hover:bg-white/10">
              ...
              <CardContent className="p-4">
                ...
                <div className="flex flex-wrap gap-1 mb-3">
                  {project.technologies.slice(0, 3).map((tech) => (
                    <Badge key={tech} className="bg-purple-500/20 text-purple-300 border-purple-500/30 text-xs">
                      {tech}
                    </Badge>
                  ))}
