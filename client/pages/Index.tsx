...
export default function Index() {
  ...
  const features = [
    {
      ...
      description:
        "Create stunning, ATS-optimized resumes with AI-powered suggestions and real-time optimization.",
    ...
    },
    {
      ...
      description:
        "Generate personalized cover letters that perfectly match job descriptions in seconds.",
    ...
    },
    {
      ...
      description:
        "Track your job applications, manage contacts, and monitor your career progress.",
    ...
    },
    {
      ...
      description:
        "Showcase your best work with beautiful portfolio layouts and project galleries.",
    ...
    },
    {
      ...
      description:
        "Get insights into your job search performance and career readiness score.",
  ...
  const steps = [
    ...
    },
    {
      ...
      details:
        "Advanced AI analyzes and enhances your content for maximum impact",
    },
    {
      ...
      details:
        "Pick from dozens of professionally designed, ATS-friendly templates",
    },
    {
  ...
  const testimonials = [
    {
      ...
      quote:
        "Profyle helped me land my dream job at Google! The AI suggestions were spot-on and the templates looked incredibly professional.",
      rating: 5,
    },
    {
      name: "Michael Chen",
      ...
      avatar: "/placeholder.svg",
      quote:
        "The interview prep feature is amazing. I felt so much more confident going into my interviews after practicing with the AI.",
      rating: 5,
    },
    {
      ...
      avatar: "/placeholder.svg",
      quote:
        "I love how easy it is to create multiple versions of my resume for different roles. The customization options are endless!",
      rating: 5,
    },
    {
      name: "David Park",
      ...
      avatar: "/placeholder.svg",
      quote:
        "The career tracker helped me stay organized during my job search. I could see my progress and knew exactly what to focus on.",
      rating: 5,
    },
  ];
  ...
  const faqs = [
    {
      ...
      answer:
        "Our AI analyzes your resume content against thousands of successful resumes and job descriptions. It provides specific suggestions for keywords, formatting, and content structure to maximize your chances of passing ATS systems and catching recruiters' attention.",
    },
    {
      question: "Can I create multiple resumes for different jobs?",
      answer:
        "Absolutely! With our Pro plan, you can create unlimited resumes and easily customize them for different roles, industries, or companies. Each resume can have different templates, content focus, and styling.",
    },
    {
      question: "Is my data secure and private?",
      answer:
        "Yes, we take data security very seriously. All your personal information is encrypted and stored securely. We never share your data with third parties, and you maintain full control over your information.",
    },
    {
      question: "What file formats can I export to?",
      answer:
        "You can export your resumes and cover letters in multiple formats including PDF, DOCX, and plain text. Our PDF exports are ATS-friendly and maintain perfect formatting across all devices.",
    },
    {
      question: "How accurate is the interview preparation?",
      answer:
        "Our interview prep feature uses real interview questions from top companies and industries. The AI provides feedback on your responses, tone, confidence level, and suggests improvements based on best practices.",
    },
    {
      question: "Can I cancel my subscription anytime?",
      answer:
        "Yes, you can cancel your subscription at any time. There are no long-term commitments, and you'll continue to have access to your paid features until the end of your billing period.",
    },
    {
      question: "Do you offer refunds?",
      answer:
        "We offer a 30-day money-back guarantee. If you're not completely satisfied with Profyle, contact our support team within 30 days of your purchase for a full refund.",
    },
    {
      question: "Is there a limit to how many times I can use the AI features?",
      answer:
        "Free users get limited AI generations per month. Pro and Enterprise users have unlimited access to all AI features including resume optimization, cover letter generation, and interview preparation.",
    },
  ];
      ...
      <section className="relative z-10 pt-20 pb-32">
        <div className="container mx-auto px-4 text-center">
          ...
          <h1 className="text-6xl md:text-7xl font-bold mb-6 leading-tight">
            Your Resume. <span className="gradient-text">Reinvented</span> with
            AI.
          </h1>

          <p className="text-xl text-gray-300 mb-12 max-w-2xl mx-auto leading-relaxed">
            Create stunning, ATS-optimized resumes in minutes. Our AI analyzes
            job descriptions and optimizes your content for maximum impact.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
            ...
            <Link to="/resume-builder">
              <Button
                size="lg"
                variant="outline"
                className="glass border-white/20 text-white hover:bg-white/10 text-lg px-8 py-4 glow-hover"
              >
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Everything you need to land your dream job, powered by
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              ...
              >
                <CardHeader>
                  <div
                    className={`w-16 h-16 rounded-2xl bg-gradient-to-r ${feature.gradient} flex items-center justify-center mb-4 glow-effect group-hover:scale-110 transition-transform`}
                  >
                    {feature.icon}
                  </div>
      ...
      <section className="relative z-10 py-20 border-t border-white/10">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Everything you need to know about Profyle and our AI-powered
              features.
            </p>
          </div>
      ...
      <section className="relative z-10 py-20 border-t border-white/10">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            ...
            careers with Profyle's AI-powered tools.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/resume-builder">
              <Button
                size="lg"
                className="gradient-bg glow-effect text-white border-0 text-lg px-8 py-4"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <p className="text-gray-400 mb-4">
                Reinventing resumes with AI technology. Build, optimize, and
