...
const authenticateToken = asyncHandler(async (req: AuthRequest, res: Response, next: Function) => {
...
router.post('/register', asyncHandler(async (req: AuthRequest, res: Response) => {
  ...
  const { email, password, firstName, lastName, phone, location } = validation.data;
